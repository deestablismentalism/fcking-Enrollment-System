                            ...
                            <div class="heducation">
                                <div class="lschool-wrapper">
                                    <div class="last-school">
                                        ...
                                        <input type="text" name="lschool" id="lschool" class="textbox">
                                    </div>
                                        <div class="lschoolID">
                            ...
                            <div class="nais-paaralan">
                                <div class="fschool-wrapper">
                                    <div class="fschool">
                                        ...
                                        <input type="text" name="fschool" id="fschool" class="textbox">
                                    </div>
                                    <div class="fschoolID">
                                        <p class="dfont">ID ng paaralan</p>
                                        <div class="error-msg">
                    ...
                    <div class="student-information border-75">
                        ...
                        <div class="student-information-wrapper">
                            ...
                            <div class="mname">
                                ...
                                <input type="text" name="mname" id="mname" class="textbox">
                            </div>
                            <div class="extension">
                                ...
                                <input type="text" name="extension" id="extension" class="textbox">
                            </div>
                            <!--ROW 3-->
                            <div class="bday">
                            ...
                            <div class="truecommunity">
                                ...
                                <input type="text" name="community" id="community" class="textbox">
                            </div>
                            <!--ROW 4-->
                            <div class="native-language">
                                <div class="language">
                                    ...
                                    <input type="text" name="language" id="language" class="textbox">
                                </div>
                            </div>
                            <div class="religion">
                                ...
                                <input type="text" name="religion" id="religion" class="textbox">
                            </div>
                            <div class="email">
                    ...
                    <div class="student-disability border-75">
                        ...
                        <div class="student-disability-wrapper">
                            <div class="special-needs">
                                <p class="dfont">Ang mag-aaral ba ay nangangailangan ng espesyal na tulong sa pag-aaral? (hal.: sa pisikal, mental, kondisyong medical, bukod sa iba pa)</p>
                            ...
                            <div class="truespecialneeds">
                                ...
                                <input type="text" name="boolsn" id="boolsn" class="textbox">
                            </div>
                            <div class="assisttech">
                                <p class="dfont">May nagagamit bang “assistive technology devices” sa inyong bahay tulad ng screen reader, braille or DAISY?</p>
                            ...
                            <div class="trueassisttech">
                                ...
                                <input type="text" name="atdevice" id="atdevice" class="textbox">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="address border-75">
                        ...
                        <div class="address-wrapper">
                            <div class="house-number">
                                ...
                                <input type="text" name="house-number" id="house-number" class="textbox">
                            </div>
                            <div class="division">
                                ...
                                <input type="text" name="division" id="division" class="textbox">
                            </div>
                            <div class="barangay">
                                ...
                                <input type="text" name="barangay" id="barangay" class="textbox">
                            </div>
                            <div class="city">
                            ...
                            <div class="province">
                                ...
                                <input type="text" name="province" id="province" class="textbox">
                            </div>
                            <div class="region">
                                ...
                                <input type="text" name="region" id="region" class="textbox">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="parents-guardian-information-wrapper">
                            <div class="father">
                                <div class="F-fullname">
                                    ...
                                    <input type="text" class="textbox" name="F-fullname" id="F-fullname">
                                </div><br>
                                ...
                                <div class="F-number">
                                    ...
                                    <input type="text" name="F-number" id="F-number" class="textbox">
                                </div>
                            </div>
                            ...
                            <div class="mother">
                                <div class="M-fullname">
                                    ...
                                    <input type="text" class="textbox" name="M-fullname" id="M-fullname">
                                </div><br>
                                ...
                                <div class="M-number">
                                    ...
                                    <input type="text" name="M-number" id="M-number" class="textbox">
                                </div>
                            </div>
                            ...
                            <div class="guardian">
                                <div class="G-fullname">
                                    ...
                                    <input type="text" class="textbox" name="F-fullname" id="G-fullname">
                                </div><br>
                                ...
                                <div class="G-number">
                                    ...
                                    <input type="text" name="G-number" id="G-number" class="textbox">
                                </div>
                            </div>
                        </div>
                    </div>
